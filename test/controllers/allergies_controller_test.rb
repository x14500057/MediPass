...
class AllergiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create allergy" do
    assert_difference('Allergy.count') do
      post allergies_url, params: { allergy: { allergy_name: @allergy.allergy_name, patient_id: @allergy.patient_id } }
    end
  ...
  test "should update allergy" do
    patch allergy_url(@allergy), params: { allergy: { allergy_name: @allergy.allergy_name, patient_id: @allergy.patient_id } }
