...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { doctor_id: @prescription.doctor_id, drug_code: @prescription.drug_code, drug_name: @prescription.drug_name, drug_strength: @prescription.drug_strength, patient_id: @prescription.patient_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { doctor_id: @prescription.doctor_id, drug_code: @prescription.drug_code, drug_name: @prescription.drug_name, drug_strength: @prescription.drug_strength, patient_id: @prescription.patient_id } }
